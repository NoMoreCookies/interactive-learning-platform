    ...
    <aside className="lg:sticky lg:top-24 lg:h-[calc(100vh-7rem)] lg:w-72 lg:shrink-0">
      <div className="flex h-full flex-col rounded-3xl border border-zinc-800 bg-zinc-950/70 p-5 backdrop-blur-xl">
            ...
            return (
              <Link
                ...
                className={[
                  ...
                  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#020617]",
                  isActive
        ...
        <div className="mt-auto border-t border-zinc-800/80 pt-5">
          <Link
            href="/"
            className="group flex items-center gap-3 rounded-2xl border border-zinc-800 px-4 py-3 text-sm text-zinc-400 transition-all duration-200 hover:border-zinc-700 hover:bg-zinc-900/70 hover:text-zinc-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
